...
- `training_snapshot`: read profile, active workout and recent context first. `create_plan` receives the selected exercises as a native tool array — the API rejects empty plans.
